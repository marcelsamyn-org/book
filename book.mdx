...
I think the answer lies somewhere in here: we have chosen (out of where, by the way?) to make this system that works, at its base, by predicting the next most-likely thing. The word, the image, the sound that has the highest probability of emerging next. You could call this The Inevitable: generative AI completes what *had* to come out.

But our whole human neurochemical system works on *surprise*—we pay attention to things when they’re *different* from what we expected. Dopamine encodes *reward prediction error*: things ending up better than expected. The reason many AI creations feel so dull is because they’re a dull starting point, stretched out, lived out until infinity. When something fascinating emerges from AI, it’s most definitely because some human gave it a unique, distinct starting point. Even though there is some randomness in AI, we still “smell” it’s not real. And we notice it’s slop.

AI isn’t taking away meaning. It’s shoving our face into meaning. It’s pushing us away from what lacked meaning anyways. AI is the embodiment of The Inevitable, surprise can only exist *in contrast to* what’s inevitable, so this technology is like a big fat arrow pointing at what actually, truly, deeply matters when you take away the surface of “working a long time on something is meaningful.”
