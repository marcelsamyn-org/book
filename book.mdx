...
There’s a trap, though, and it’s called *cognitive fixation* or *functional fixedness*. When we recognize objects, we see them in *how they can be used* and we have trouble seeing other ways the same thing could be used.
