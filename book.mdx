...
One way of understanding what AI is, is seeing it as "collective intelligence." This framing also helps intuit the common mistakes it makes of overgeneralizations and hallucinations. In a way, large language models are just a condensed summary of everything everyone has ever written down, plus a very good search engine through all that. It's the best way to find out what humanity thinks of something.
