...
This is interesting behavior to me: it does seem like there’s some kind of intelligence where the model seems to understand “ah so that’s how an AI should behave” *implicitly*. The fact that this method works well, without us needing to train it on direct examples of chat conversations, is a great sign.
