...
"Happiness" can be a fuzzy concept but there's been a lot of work in the field of psychology to define it. We'll use their definitions to get a complete understanding of where and how AI has its influence, so we learn exactly how to calibrate our technology and our own behavior to become happier.
