...
In research, they test for your post-traumatic growth with questionnaires. Here’s the **PTGI‑X‑SF**, a short version of **PTGI-X** which in itself is an updated version of the initial questionnaire that includes a more refined spiritual growth section that’s not as tightly coupled with religious beliefs.
