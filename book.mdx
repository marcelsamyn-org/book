...
True happiness---not just comfort and security---needs something more, and as you'll see that deeper sense of happiness has a lot to do with our self-image.

- [ ] TODO: Above - Not sure what transition to put here. Maybe the next bits belong somewhere else.
...
Then comes the more philosophical and controversial part: tweaking severity and chronicity of hardship. If we imagine a superintelligence, it's not too far off to imagine that this intelligence could be very aware of what impacts our lives, positively and negatively, over what time frame. It could, theoretically, tweak each person's day-to-day challenge level in a way that is right on that optimal level of challenge so they grow and become more happy. It could tell you that today you'll have to weed the corn field by hand between all the machines that are way faster and better than you, because you've been having a life that's too easy for the past few weeks.

Why does this sound so dystopian?
